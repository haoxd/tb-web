 ...
 */
function login() {
    return location.href = "http://sso.tb.com/user/login.html";
}
function regist() {
    return location.href = "http://sso.tb.com/user/register.html";
}
...
function search(a) {
    var b = "http://search.tb.com/S/Search.html?keyword=" + encodeURIComponent(document.getElementById(a).value);
